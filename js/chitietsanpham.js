...
function phanTich_URL_chiTietSanPham() {
    ...
    s += addThongSo('Đối tượng', sanPhamHienTai.detail.os);
    s += addThongSo('Kháng nước', sanPhamHienTai.detail.camara);
    s += addThongSo('Chất liệu kính', sanPhamHienTai.detail.camaraFront);
    s += addThongSo('Size mặt', sanPhamHienTai.detail.cpu);
    s += addThongSo('Loại máy', sanPhamHienTai.detail.ram);
    s += addThongSo('Chất liệu dây', sanPhamHienTai.detail.rom);
    s += addThongSo('Độ dầy', sanPhamHienTai.detail.microUSB);
    s += addThongSo('Tiện ích', sanPhamHienTai.detail.battery);
    info.innerHTML = s;
