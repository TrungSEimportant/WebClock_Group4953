	...
	<div class="top-nav group">
        <section>
            ...
            <ul class="top-nav-quicklink flexContain">
                ...
                <li><a href="gioithieu.html"><i class="fa fa-info-circle"></i> Introduce</a></li>
                <li><a href="trungtambaohanh.html"><i class="fa fa-wrench"></i> Guarantee</a></li>
                <li><a href="lienhe.html"><i class="fa fa-phone"></i> Contact</a></li>
            </ul> <!-- End Quick link -->
        </section><!-- End Section -->
    </div><!-- End Top Nav  -->`);
}
            ...
            <div class="search-header" style="position: relative; left: 162px; top: 1px;">
                <form class="input-search" method="get" action="index.html">
                    <div class="autocomplete">
                        <input id="search-box" name="search" autocomplete="off" type="text" placeholder="Enter search keyword...">
                        <button type="submit">
            ...
            <div class="tools-member">
                <div class="member">
                    ...
                    <div class="menuMember hide">
                        <a href="nguoidung.html">User page</a>
                        <a onclick="if(window.confirm('Confirm logout ?')) logOut();">Log Out</a>
                    </div>
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">VT Store</a> - All rights reserved © 2021 - Designed by
            <span style="color: #eee; font-weight: bold">VTSTORE</span></p>
    </div>`);
}
            ...
            <div class="tab-content">
                <div id="login">
                    ...
                    <form onsubmit="return logIn(this);">
                        ...
                        <p class="forgot"><a href="#">Fogot password?</a></p>
    ...
    <div class="plc">
        <section>
            <ul class="flexContain">
                ...
                <li>Error exchange at home within 1 day</li>
                <li>Lifetime support.
                    <br>Hotline:
                    <a href="tel:0795625822" style="color: #288ad6;">0795625822</a>
                </li>
            </ul>
        </section>
    </div>`);
...
function checkLocalStorage() {
    if (typeof(Storage) == "undefined") {
        alert('The computer does not support LocalStorage. Unable to save product and customer information!!');
    } else {
